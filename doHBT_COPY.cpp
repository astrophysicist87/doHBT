...
void doHBT::Analyze_sourcefunction(FO_surf* FOsurf_ptr)
{
   ...
   //cout << "Determine nth-order plane angles..." << endl;
   Determine_plane_angle(FOsurf_ptr);
   int iorder = 3;
   //cout << "Analyzing source function w.r.t " << iorder << " th-order participant plane angle..." << endl;
   cout << "psi = " << plane_angle[iorder] << endl;
